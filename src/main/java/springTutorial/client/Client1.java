...
public class Client1 {
	...
	public static void main(String[] args) {
		BeanFactory factory = new ClassPathXmlApplicationContext(
				"client1.spring.xml");
		Client1 client = (Client1) factory.getBean("client");
		client.runClient();	
	}
	...
	public void runClient(){
		...
		try {
			moneyService.transferMoney("Jan", "Piet", 150f, "zesde"); // te veel transacties
		} catch (TooManyMoneyTransactionsException e) {
		...
		System.out.printf("%s: EUR %.2f\n", "Jan", accountService.getAccountBalance("Jan"));
		System.out.printf("%s: EUR %.2f\n", "Piet", accountService
